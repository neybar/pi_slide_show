...
// Import shared utility functions from the shared module
// These are the same functions used by www/js/main.js (via window.SlideshowUtils)
import {
  buildThumbnailPath,
  qualityLevel,
  shouldSkipUpgrade,
